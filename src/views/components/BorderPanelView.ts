  ...
  constructor() {
    ...
    this.append(
      new DivElement({
        ...
        children: [
          new ImageElement({ src: "/images/border-pane-primary.png", alt: "Primary Layout", className: "w-1/2", style: { maxWidth: "400px" } }),
          new ImageElement({ src: "/images/border-pane-secondary.png", alt: "Secondary Layout", className: "w-1/2", style: { maxWidth: "400px" } }),
        ],
      })
    );
